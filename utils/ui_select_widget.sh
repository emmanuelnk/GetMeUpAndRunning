...
# DEMO 
# - ASCIINEMA: https://asciinema.org/a/Y4hLxnN20JtAlrn3hsC6dCRn8
...
# Use a number between 1 and 7
# write as below in bash:

# run_ui_widget_select_example 1
# run_ui_widget_select_example 4
# run_ui_widget_select_example 7
...
run_ui_widget_select_example() {
    case "$1" in
        ...
        *) echo "Example $1 does not exist. Choose a number between 1 and 7."
            ;;
    esac
}
